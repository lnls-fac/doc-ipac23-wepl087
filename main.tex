...
% For each turn, the 160 BPMs synchronized acquisition data was was used to fit the trajectory initial conditions ($x, x^\prime$) at the injection point. 
